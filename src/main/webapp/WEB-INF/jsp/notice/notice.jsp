...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="text-align: center">欢迎使用CRM员工管理公告模块</legend>
</fieldset>
            ...
            <table class="layui-table">
                ...
                <c:forEach items="${docList}" var="d">
                    ...
                    <tr>
                        ...
                        <td style="text-align: center"><a href="<%=contextPath%>/notice/delNo?id=${d.id}">删除</a>&nbsp;|&nbsp;<a
                                href="<%=contextPath%>/notice/lookNo?id=${d.id}">查看</a></td>
                    </tr>
                    </tbody>
                </c:forEach>
            </table>
